...
// //Вызов функции до объявление сгенерирует ошибку: Cannot access 'comp' before initialization
...
// const fc = new Function (params,body);
// fc(2,3);
...
// const arr_muliplied = Array.from(arr,el => el**2);
// const arr_filtered  = arr_muliplied.filter(el => el < 100);
// const arr_sorted = arr_filtered.sort((a,b)=> a > b ? 1: -1);
...
// const parts = function(...rest){
//     return  rest.map(el => {
//         const colon_pos = el.indexOf(":");
//         const after_colon_sub_str = el.slice(colon_pos + 1);
//         const dot_pos = after_colon_sub_str.indexOf(".");
//         const sub_str = after_colon_sub_str.slice(0, dot_pos);
//         return sub_str.trim();
//      }
//     )
// }
...
//const testString = 'abc', test ='b'
//const testString = 'abc'
//const testString = 'abc', test = 'd'
//const testString = 'abc', test='a', test2='b'

// const f = function find(testString, test=testString){
//     return testString.indexOf(test);
// }

// console.log(f(testString,test));
// console.log(f(testString));
// console.log(f(testString,test));
// console.log(f(testString,test,test2));
...
//     //window.alert(param) - no supported by this environment
//      console.log("alert(" + param + ")");
// }

// function splitToWords(msg, callback){
//     var rex = ' ';
//     const split = msg.split(rex);
//     if (callback){
...
// const copyright = function (sign){
//     return (param) => sign + ' ' + param;
// }
...
//         return n;
//     }else {
//         let fn_1 = memory.get(n-1);
//         if (!fn_1){
//             fn_1 = fiboMemo(n - 1);
//         }

//         let fn_2 = memory.get(n-2);
//         if (!fn_2){
//             fn_2 = fiboMemo(n-2);
//         }
        
//         let result = fn_1 + fn_2 ;
